            ...
            <main className="create-job">
                <div className="container primary" >
                    ...
                    <form className="form-create-job mx-auto" onSubmit={handleSubmit}>
                        ...
                        <div className="row">
                            <div className="col-12 mb-4">
                                <input className="form-control form-control-lg" type="text" name="jobs_benefits"  value={createJob.jobs_benefits} onChange={handleChange} aria-label='Job benefits' placeholder="Benefits" autoComplete='on' disabled={ jobStatus === 'publish' ? true : false} required />
                            </div>
                        </div>
                        <div className="row">
                            <div className="col-12 mb-4">
